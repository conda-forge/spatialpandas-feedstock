...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/spatialpandas-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10260&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/spatialpandas-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `spatialpandas` can be installed with:

```
conda install spatialpandas
```

It is possible to list all of the versions of `spatialpandas` available on your platform with:
